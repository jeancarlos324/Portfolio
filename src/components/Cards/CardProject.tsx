  ...
  return (
    <motion.div {...otherProps} onClick={(e) => e.stopPropagation()}>
      <div className="relative">
        <CaroulselImages images={data.images} className="rounded-t-popup" />
        <motion.div className="px-6 py-3 flex flex-col gap-2">
          ...
          <div>
            ...
            <p className="text-justify italic">{data.description}</p>
          </div>
          ...
          <motion.div className="flex flex-col gap-2">
            <h3 className="font-semibold">Tiempo estimado de desarrollo:</h3>
            <span className="text-litle-title-card italic">
              {data.duration}
            </span>
          </motion.div>
